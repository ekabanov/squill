...
public class   Tuple8 < T1,T2,T3,T4,T5,T6,T7,T8 >  implements Tuple {
  ...
  public static < P1,P2,P3,P4,P5,P6,P7,P8 > Tuple8< P1,P2,P3,P4,P5,P6,P7,P8 > _( P1 v1,P2 v2,P3 v3,P4 v4,P5 v5,P6 v6,P7 v7,P8 v8 ) {
    return new Tuple8< P1,P2,P3,P4,P5,P6,P7,P8 >( v1,v2,v3,v4,v5,v6,v7,v8 );
  }
